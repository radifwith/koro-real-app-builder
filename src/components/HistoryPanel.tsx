import { X, MessageSquare, Search, Brain, Image, BookOpen, HelpCircle, Code } from "lucide-react";
...
const HistoryPanel = ({ isOpen, onClose, sessions, onLoadSession }: HistoryPanelProps) => {
            ...
            sessions.map((session) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left p-3 rounded-xl glass-card-hover btn-glow transition-all duration-200 group"
                >
